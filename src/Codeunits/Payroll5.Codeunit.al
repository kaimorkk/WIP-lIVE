          ...
          begin
            repeat
             ...
             if AmountRemaining<=0 then
              ...
              // MESSAGE('TaxableAmt=%1\Percentage=%2\Tax=%3\TotalTax=%4',TaxTable."Taxable Amount",TaxTable.Percentage,Tax,TotalTax);
               end
              else
               begin
               ...
               //Only the amount in the last Tax band had issues.
                ...
                Tax:=AmountRemaining*TaxTable.Percentage/100;
               // Tax:=ROUND(Tax,0.05,'<');
              //MESSAGE('TaxableAmount=%1\LowerLimit=%4\AmountRemaining=%2\Tax=%3',TaxableAmount,AmountRemaining,Tax,TaxTable."Lower Limit");

                //MESSAGE('AmountRemaining=%1\Tax=%2',AmountRemaining,Tax);
              // MESSAGE('Percent %1 %2',TaxTable.Percentage,Tax);
    ...
    begin
         ...
         if EmpRec.Find('-') then begin
          if EmpRec."Pays tax"=true then begin
           ...
           //MESSAGE('TaxableAmount=%1',EmpRec."Taxable Allowance");

           TaxableAmount:=EmpRec."Taxable Allowance"+EmpRec."Relief Amount";
          // mine:=EmpRec."Taxable Allowance";
         // MESSAGE('Relief=%1, TaxableAmount=%2',EmpRec."Relief Amount",TaxableAmount);
          Ded.Reset;
          ...
          // MESSAGE('%1 RetirementCont=%2',EmployeeNo,RetirementCont);

             TaxableAmount:=TaxableAmount-RetirementCont;
           // end Taxable Amount
           // added to cater for Owner occupier Specific
         // MESSAGE('TaxableAmount-RetirementCont=%1',TaxableAmount);
         ...
         //MESSAGE('TaxableAmount-OO=%1',TaxableAmount);
        ...
        // Low Interest Benefits
         ...
         //End of Low Interest benefits
          //MESSAGE('TaxableAmount-LI=%1',TaxableAmount);

         //TaxableAmount:=ROUND(TaxableAmount,0.01,'<');
         TaxableAmountNew:= TaxableAmount;

         // Get PAYE
        //MESSAGE('TaxableAmountNew=%1',TaxableAmountNew);
