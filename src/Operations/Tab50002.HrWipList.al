   ...
   table 50002 "HR Employees"
{
    ...
    fields
    {
        ...
        field(39004042; "Hander Name"; Text[300])
        {
          ...
          field(39004045; "Total Earnings"; Decimal)
        {
            DecimalPlaces = 2 : 2;
            FieldClass = FlowField;
            Editable = false;
            CalcFormula=sum("PR Employee Transactions".Amount where("Employee Code"=field("No."),Amount = filter(> 0)));
        }
