page 69895 "Approved Mgt Transfer"
{
    Caption = 'Approved Management Initiated Employee Transfer';
        ...
        area(content)
        {
            group(General)
            {
                ...
                group(Transfer)
                {
                    ...
                    field("Mobility Release Date"; Rec."Mobility Release Date")
                    {
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Reporting Date field.';
                        Caption = 'Mobility Release Date';
                    }
            ...
            action("Post")
            {
                ...
                begin
                    ...
                    if Status = Status::Released then begin
                        ...
                        Message('Sucessfully Submitted for Current HOS Release');
