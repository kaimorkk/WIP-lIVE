page 52193991 "Fleet Management Setup"
{
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Vehicle Entitlement Nos."; Rec."Vehicle Incident Nos.")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Vehicle Entitlement Nos. field.';
                }
                field("Vehicle Request Nos."; Rec."Vehicle Request Nos.")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Vehicle Request Nos. field.';
                }
                ...
                field("Tyre Requisition Nos"; Rec."Tyre Requisition Nos")
                {
                    ApplicationArea = All;
                    ToolTip = 'Specifies the value of the Tyre Requisition Nos';
                }
