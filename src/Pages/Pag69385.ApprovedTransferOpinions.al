page 69385 "Approved Transfer Opinions"
{
    Caption = 'Approved Transfer Prefessional Opinion';
    PageType = List;
    CardPageId = "Transfer Opinion Card";
    SourceTable = "Employee Transfers";
    UsageCategory = None;
    Editable = false;
    SourceTableView = where(Type = const("..."), "Document Type" = const("Professional Opinion"),
