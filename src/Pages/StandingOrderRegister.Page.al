Page 52193570 "Standing Order Register"
{
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                field(DeductionStatus;"Deduction Status")
                {
                    ApplicationArea = Basic;
                }
                ...
                field(TransferedtoEFT;"Transfered to EFT")
                {
                    ApplicationArea = Basic;
                }
                field(StandingOrderNo;"Standing Order No.")
                {
                    ApplicationArea = Basic;
                }
            }
