page 69892 "Apps Awaiting Mobility"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                group(Transfer)
                {
                    ...
                    // }
                    field("Suggested Station 1"; Rec."New Station")
                    {
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Preferred Station 1 field.';
                        Caption = 'New Station Code';
                    }
                    field("Suggested Station 1 Name"; Rec."New Sattion Name")
                    {
                        ApplicationArea = All;
                        ToolTip = 'Specifies the value of the Preferred Station 1 Name field.';
                    ...
                    //     Visible = Rec.Type = Rec.Type::"Mgt Initiated Deployment";
                    // }
                    // field("Current Implementing Unit"; Rec."Current Implementing Unit")
                    // {
                    //     ApplicationArea = All;
                    //     ToolTip = 'Specifies the value of the Current Implementing Unit field.';
                    //     Visible = Rec.Type = Rec.Type::"Mgt Initiated Deployment";
                    // }
                    // field("New Implementing Name"; Rec."New Implementing Name")
                    // {
                    //     ApplicationArea = All;
                    //     ToolTip = 'Specifies the value of the New Implementing Name field.';
                    //     Visible = Rec.Type = Rec.Type::"Mgt Initiated Deployment";
                    // }
    ...
    actions
    {
        area(navigation)
        {
            ...
            action("Post")
            {
                ...
                Caption = 'Submit Reccomendation to HOD Mobility';
