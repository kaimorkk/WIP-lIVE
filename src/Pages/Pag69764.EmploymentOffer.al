...
page 69764 "Employment Offer"
{
    ...
    actions
    {
        area(processing)
        {
            ...
            //         if Confirm(TXT001) = true then begin
            //             // Rec.TestField("Orientation Status", Rec."Orientation Status"::Oriented);
            //             //Rec.TestField("Offer Acceptance Status", Rec."Offer Acceptance Status"::Accepted);
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref("Offer Appointment_Promoted"; "Offer Appointment")
                {
                }
            }
    ...
    var
        myInt: Integer;
    begin
        Rec."Document Type" := Rec."Document Type"::"Offer letter";
    end;
