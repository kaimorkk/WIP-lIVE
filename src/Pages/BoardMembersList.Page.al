Page 52194422 "Board Members List"
{
    ...
    actions
    {
        ...
        area(reporting)
        {
            ...
            group(FinancialManagement)
            {
                ...
                action(SupplierDetailTrialBalance)
                {
                    ApplicationArea = Basic;
        ...
        area(Promoted)
        {
            ...
            group(Category_Report)
            {
                ...
                actionref(SupplierBalancetoDate_Promoted; SupplierBalancetoDate)
                {
                }
            }
        }
    ...
    trigger OnOpenPage()
    begin
        SetRange("Vendor Posting Group", 'BRD&TRIBUN');
    end;
