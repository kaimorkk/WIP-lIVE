page 69880 "Transfers Awaiting HOS Release"
{
    Caption = 'Transfers Awaiting HOS Release';


    PageType = List;
    CardPageId = "Transfer Awaiting HOS Release";
    SourceTable = "Employee Transfers";
    UsageCategory = None;
    Editable = false;
    SourceTableView = where(Type = const("Self initiated"), "Document Type" = const(Application),
    "Status" = filter("Pending Current HOS Release"), Posted = const(false));
