page 50350 "Draft Workplan Cons. Card"
{
        ...
        area(content)
        {
            group(General)
            {
                ...
                field("Planning Budget Type"; Rec."Planning Budget Type")
                {
                    ...
                    ToolTip = 'Specifies the value of the Planning Budget Type field.', Comment = '%';
                }
    ...
    actions
    {
        area(creation)
        {
            ...
            action(SendToNA)
            {
                ...
                ApplicationArea = Basic, Suite;
                Visible = (Rec."Approval Status" = Rec."Approval Status"::Released) and (Rec.Stage = Rec.Stage::Finance) and (Rec."Planning Budget Type" = Rec."Planning Budget Type"::Supplementary);
            ...
            action(RevisedEstimates)
            {
                Caption = 'Generate Revised Estimates';
                ApplicationArea = Basic, Suite;
                Visible = (Rec."Approval Status" = Rec."Approval Status"::Released) and (Rec.Stage = Rec.Stage::Finance) and (Rec."Planning Budget Type" = Rec."Planning Budget Type"::"Supplementary 2");
                //Visible = (Rec.Stage = Rec.Stage::JSC);
                Promoted = true;
                PromotedCategory = Process;
                Image = SendTo;
                ...
                var
                    WorkplanMgt: Codeunit "Workplan Management";
                begin
                    if Confirm('Are you sure you want to post this supplementary budget', false) then
            ...
            action(MakeProcPlan)
            {
                Caption = 'Generate Procurement Plan';
                ApplicationArea = Basic, Suite;
                ...
                var
                    WorkplanMgt: Codeunit "Workplan Management";
                begin
                    if Confirm('Are you sure you want to create the procurement plan?', false) then
                        WorkplanMgt.GenerateProcurementPlan(Rec);
                    Currpage.Close();
                end;
            }
            ...
            group(Attachments)
            {
                action("Attach Documents")
                {
                    ...
                    begin
                        DocType := DocType::"Consolidated Workplans";
                        DMSManagement.GetDocument(DocType, Rec.Code, Rec.RecordID, 'FNC', 80265, 'Consolidated Workplans');
                    end;
                }
    ...
    begin
        ...
        //Rec."Budget Type" := Rec."Budget Type"::Finance;
    end;
