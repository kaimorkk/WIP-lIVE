page 52193510 "External training applications"
{
    ApplicationArea = All;
    Caption = 'Self-Sponsored Training Applications';
    PageType = List;
    SourceTable = "Training Requests";
    CardPageId = "Training Application External";
    UsageCategory = Lists;
    SourceTableView = where(Status = filter(Open | "Pending Approval"), "Funding Source" = filter(<> Internal));
