Page 52194272 "GS Conf/Seminar Evaluations"
{
    CardPageID = "Conf/Seminar Evaluation";
    PageType = List;
    ...
    layout
    {
        area(content)
        {
            repeater(Group)
            {
                ...
                field(Difficult1;"Difficult 1")
                {
                    ApplicationArea = Basic;
                }
                field(Difficult2;"Difficult 2")
                {
                    ApplicationArea = Basic;
                }
                ...
                field(Suggestion3;"Suggestion 3")
                {
                    ApplicationArea = Basic;
                }
                field(Suggestion4;"Suggestion 4")
                {
                    ApplicationArea = Basic;
                }
            }
