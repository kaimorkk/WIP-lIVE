    ...
    actions
    {
        area(processing)
        {
            group("&Line")
            {
                ...
                action("Audit Finding Criteria")
                {
                    ApplicationArea = Basic;
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Criteria";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");
                    ToolTip = 'Executes the Audit Finding Criteria action.';
                }
                action("Audit Finding Conditions")
                {
                    ApplicationArea = Basic;
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Conditions";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");                    
                    ToolTip = 'Executes the Audit Finding Conditions action.';
                }
                action("Audit Finding Risks")
                {
                    ApplicationArea = Basic;
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Risks";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");                    
                    ToolTip = 'Executes the Audit Finding Risks action.';
                }
                action("Audit Finding Recomm.")
                {
                    ApplicationArea = Basic;
                    Caption = 'Audit Finding Recommendations';
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Recomm.";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");
                    ToolTip = 'Executes the Audit Finding Recomm. action.';
                }
                action("Audit Finding Mgmt. Response")
                {
                    ApplicationArea = Basic;
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Mgmt. Response";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");
                    ToolTip = 'Executes the Audit Finding Mgmt. Response action.';
                }
                action("Audit Finding Review Comments")
                {
                    ApplicationArea = Basic;
                    Image = Dimensions;
                    RunObject = Page "Audit Finding Review Comments";
                    RunPageLink = "Document No." = field("Document No."),
                                    "Finding ID" = field("Finding ID"),
                                    "Document Type" = field("Document Type"),
                                    "Engagement ID" = field("Engagement ID"),
                                  "Checklist ID" = field("Checklist ID");
                    ToolTip = 'Executes the Audit Finding Review Comments action.';
                }
            }
        }
    }
