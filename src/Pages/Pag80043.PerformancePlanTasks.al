        ...
        area(processing)
        {
            group("Line Functions")
            {
                ...
                action("Nofify Staff")
                {
                    ...
                    trigger OnAction()
                    begin
                        if not Confirm('Are you sure you want to send an email to all staff?') then exit;
                    end;
                }
                ...
                action("Send a Reminder")
                {
                    ...
                    trigger OnAction()
                    begin
                        if not Confirm('Are you sure you want to send a reminder to all staff?') then exit;
                    end;
                }
            }
        }
