page 69835 "Approved Management Transfers"
{

    Caption = 'Approved Management initiated Employee Transfer List';
    PageType = List;
    // CardPageId = "Management Employee Transfer";
    CardPageId = "Approved Transfer Requests";
    SourceTable = "Employee Transfers";
    UsageCategory = None;
    Editable = false;
    SourceTableView = where(Type = const("Management initiated"), "Document Type" = const(Application),
                            "Status" = filter(Released), Posted = const(false));
