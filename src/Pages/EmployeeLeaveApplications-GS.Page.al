Page 52194002 "Employee Leave Applications-GS"
{
    ...
    begin
        ...
        //MESSAGE('MaturityDate=%1',MaturityDateFilter);
        Bal:=0;
        TotalDays:=0;
        Recalled:=0;
        Absent:=0;
        ...
        if "Employee Leaves".Find('-') then  begin
           EmpLeaveApps.Reset;
           EmpLeaveApps.SetRange(EmpLeaveApps."Employee No","No.");
           EmpLeaveApps.SetRange(EmpLeaveApps."Leave Code","Employee Leaves"."Leave Code");
           EmpLeaveApps.SetRange(EmpLeaveApps."Maturity Date",MaturityDateFilter);
          ...
          // EmpLeaveApps.CALCFIELDS(EmpLeaveApps."Days Applied");
           ...
           until EmpLeaveApps.Next=0;
            ...
            EmpOffs.SetRange(EmpOffs."Maturity Date",MaturityDateFilter);
            ...
            EmpAbsence.SetRange(EmpAbsence."Maturity Date",MaturityDateFilter);
