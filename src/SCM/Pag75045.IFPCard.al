...
page 75045 "IFP Card"
{
    ...
    actions
    {
        ...
        area(Promoted)
        {
            ...
            {
                Caption = 'Schedules', Comment = 'Generated from the PromotedActionCategories property index 7.';
            ...
            {
                Caption = 'Attachments', Comment = 'Generated from the PromotedActionCategories property index 8.';
