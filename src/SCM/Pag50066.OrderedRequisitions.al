...
page 50164 "Ordered Requisitions"
{
    AutoSplitKey = true;
    Caption = 'Lines';
    DelayedInsert = true;
    ...
    layout
    {
        area(content)
        {
            repeater(Control1)
            {
                ...
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Ordered by field.';
                }
                field("Order Creation date"; Rec."Order Creation date")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Order Creation date field.';
                }
                field("Order Creation Time"; Rec."Order Creation Time")
                {
                    ApplicationArea = Basic;
                    ToolTip = 'Specifies the value of the Order Creation Time field.';
                }
