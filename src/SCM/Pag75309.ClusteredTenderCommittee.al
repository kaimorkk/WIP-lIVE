    ...
    actions
    {
        ...
        area(Promoted)
        {
            group(Category_Process)
            {
                ...
                actionref("Clustered Tenders_Promoted"; "Clustered Tenders")
                {
                }
            }
            ...
            {
                Caption = 'Manage', Comment = 'Generated from the PromotedActionCategories property index 7.';
            ...
            {
                Caption = 'Send for Approvals', Comment = 'Generated from the PromotedActionCategories property index 8.';
