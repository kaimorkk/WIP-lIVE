            ...
            repeater(Control1)
            {
                ...
                field("Qty. Requested"; Rec."Qty. Requested")
                {
                    ...
                    begin
                        ...
                        if Rec."Qty. Requested" > Rec."Quantity In Store" then begin
                            Error('Quantity Requested cannot exceed the Quantity in Store.');
                        end else begin
                            Rec."Quantity To  Issue" := Rec."Qty. Requested";
                            Rec.Modify();
                        end;
                    end;
                }
