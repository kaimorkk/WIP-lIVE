page 50501 "Unplanned AIE Card"
{
    Caption = 'Unplanned AIE Card';
    PageType = Card;
    ...
    layout
    {
        area(content)
        {
            group(General)
            {
                ...
                field("Funded Unit"; Rec."Funded Unit")
                {
                    ApplicationArea = All;
                    Caption = 'Unit to Fund';
                    ToolTip = 'This is the mobile court that is receiving the AIE', Comment = '%';
                }
    ...
    begin
        ...
        if Lines.FindSet() then
            repeat
                ...
                if Lines."Amount to Authorize" > Lines.Balance then
                    Error('Amount to Authorize cannot be greater than the balance.Check Line %1', Lines."G/L Account");
