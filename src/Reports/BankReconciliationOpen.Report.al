...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511248_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511248) { }
//type("System.IO.Path"; System_IO_Path51511248) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193649 "Bank Reconciliation Open"
{
    RDLCLayout = './Layouts/BankReconciliationOpen.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Bank Acc. Reconciliation Line"; "Bank Acc. Reconciliation Line")
        {
            ...
            begin
                ...
                // "Bank Acc. Reconciliation Line".SetRange("Bank Acc. Reconciliation Line".Closed, true);
                // "Bank Acc. Reconciliation Line".SetRange("Bank Acc. Reconciliation Line"."Closing Date", ReconClosingDate);
            end;

            trigger OnAfterGetRecord();
            begin
                // "Bank Acc. Reconciliation Line".Closed := false;
                // "Bank Acc. Reconciliation Line"."Closing Date" := 0D;
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511248_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511248;
