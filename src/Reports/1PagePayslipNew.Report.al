...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511117_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511117) { }
//type("System.IO.Path"; System_IO_Path51511117) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193537 "1 Page Payslip New"
{
    RDLCLayout = './Layouts/1PagePayslipNew.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Employee; Employee)
        {
            ...
            dataitem("Assignment Matrix-X1"; "Assignment Matrix-X1")
            {
                ...
                column(Employee__Total_Allowances___Employee__Benefits_Non_Cash_; Employee."Total Allowances" + Employee."Benefits-Non Cash")
                {
                }
                column(Employee__Total_Deductions_; Employee."Total Deductions")
                {
                }
            ...
            begin
                ...
                Employee.CalcFields("Taxable Allowance", "Tax Deductible Amount", Employee.Basic);
                ...
                TaxablePay := Employee."Taxable Allowance";
                ...
                NetPay := Employee."Total Allowances"
                        + Employee."Total Deductions" + Employee."Total Savings";
                // To compute coinage
                NetPay1 := NetPay;
                Index := 1;
                Intex := 1;
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511117_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511117;
