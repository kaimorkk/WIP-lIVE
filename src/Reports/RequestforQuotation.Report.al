...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511025_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511025) { }
//type("System.IO.Path"; System_IO_Path51511025) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193463 "Request for Quotation"
{
    UsageCategory = Documents;
    RDLCLayout = './Layouts/RequestforQuotation.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Supplier Selection1"; "Supplier Selection1")
        {
            ...
            column(ReportForNavId_1000000039; 1000000039) { } // Autogenerated by ForNav - Do not delete
            column(Supplier_Selection1_Reference_No_; "Supplier Selection1"."Reference No.")
            {
            }
            ...
            column(Invitation; StrSubstNo(InvitationLbl, ReturnTime, ReturnDate))
            {
            }
            ...
            dataitem("Procurement Request Lines1"; "Procurement Request Lines1")
            {
                ...
                column(ReportForNavId_5775; 5775) { } // Autogenerated by ForNav - Do not delete
                ...
                column(UnitPrice; "Procurement Request Lines1"."Unit Price")
                {
                }
                column(TotalAmount; "Procurement Request Lines1".Amount)
                {
                }
                ...
                column(DataItem1000000066; Signature_________________Caption_Control1000000066Lbl)
                {
                }
                column(DataItem1000000067; Signature_________________Caption_Control1000000067Lbl)
                {
                }
                column(Time_________________Caption; Time_________________CaptionLbl)
                {
                }
                column(DataItem1000000069; Designation_________________Caption_Control1000000069Lbl)
                {
                }
                column(DataItem1000000070; Designation_________________Caption_Control1000000070Lbl)
                {
                }
    ...
    var
        ...
        QUANTITY_REQUIREDCaptionLbl: label 'QUANTITY';
        ...
        b__This_____________________________________CLbl: label '(b) This quotation should be submitted in palin wax sealed envelope marked  "Quotation No....................................';
        CODE_No_CaptionLbl: label 'ITEM NO';
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511025_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511025;
