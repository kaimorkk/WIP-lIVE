...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511458_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511458) { }
//type("System.IO.Path"; System_IO_Path51511458) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193736 "Two Column TB"
{
    RDLCLayout = './Layouts/TwoColumnTB.rdlc';
    DefaultLayout = RDLC;
        ...
        dataitem("G/L Account"; "G/L Account")
        {
            ...
            begin
				...
				*/
                ...
                if "G/L Account"."Income/Balance" = "G/L Account"."income/balance"::"Balance Sheet" then begin
                    if "G/L Account"."Account Type" = "G/L Account"."account type"::Posting then begin
                        if "Balance at Date" > 0 then
                            Totaldebit := Totaldebit + "Balance at Date";
                        if "Balance at Date" < 0 then
                            Totalcredit := Totalcredit + "Balance at Date";
                    end;
                end;
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511458_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511458;
