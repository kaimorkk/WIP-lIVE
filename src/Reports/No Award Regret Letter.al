report 70115 "No Award Regret Letter"
{
    DefaultLayout = RDLC;
    RDLCLayout = './Layouts/No Award Regret Letter.rdlc';

    dataset
    {
        dataitem("Bid Tabulation Line";"Bid Tabulation Line")
        {
            column(CEO;UserSetup.Picture)
            {
            }
            column(Name;UserSetup."Employee Name")
            {
            }
            column(TabulationID_BidTabulationLine;"Bid Tabulation Line"."Tabulation ID")
            {
            }
            column(RMRKS;"Bid Tabulation Line"."Evaluation Committee Remarks")
            {
            }
            ...
            dataitem("Bid Tabulation Header";"Bid Tabulation Header")
            {
                ...
                begin
                    // Employee.RESET;
                    // Employee.SETRANGE("Chief Executive Officer",TRUE);
