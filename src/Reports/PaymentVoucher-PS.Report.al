Report 52193450 "Payment Voucher-PS"
{
    RDLCLayout = './Layouts/PaymentVoucher-PS.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem(Payments; Payments)
        {
            ...
            begin
                ...
                Payments.CalcFields("Total Amount", "Amount Approved");
                InitTextVariable;
                FormatNoText(NumberText, "Amount Approved", '');
                Banks.Reset;
