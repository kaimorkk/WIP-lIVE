...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511004_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511004) { }
//type("System.IO.Path"; System_IO_Path51511004) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193445 "Store Requisition"
{
    ...
    dataset
    {
        ...
        {
            DataItemTableView = sorting("No.") where("Requisition Type" = const("Store Requisition"));
            ...
            column(DirectorateCaption; DirectorateCaptionLbl)
            {
            }
            column(REQUESTED_QTYCaption; REQUESTED_QTYCaptionLbl)
            {
            }
            ...
            column(APPROVED_QTYCaption; APPROVED_QTYCaptionLbl)
            {
            }
            ...
            column(Please_Issue_the_following_items_on_our_behalfCaption; Please_Issue_the_following_items_on_our_behalfCaptionLbl)
            {
            }
            ...
            column(QTY_IN_STORECaption; QTY_IN_STORECaptionLbl)
            {
            }
            column(Issued_by; "Requisition Header1"."Posted By")
            {
            }
            column(Issuer; Issuer)
            {
            }
            column(Requisition_Header_Date_Posted; "Requisition Header1"."Date Posted")
            {
            }
            column(Requisition_Header1_Date_Issued; "Requisition Header1"."Date Issued")
            {
            }
            column(Requisition_Header1_Received_By; "Requisition Header1"."Received By")
            {
            }
            column(Requisition_Header1_Date_Received; "Requisition Header1"."Date Received")
            {
            }
            dataitem("Requisition Lines1"; "Requisition Lines1")
            {
                ...
                column(Requisition_Lines1__Requisition_Lines1___Quantity_Approved_; "Requisition Lines1"."Quantity Approved")
                {
                }
                ...
                column(Requisition_Lines1__Quantity_in_Store_; "Requisition Lines1"."Quantity in Store")
                {
                }
            ...
            trigger OnAfterGetRecord();
            begin
                Dimvalues.SetRange(Dimvalues."Dimension Code", GenLedSetup."Global Dimension 2 Code");
                Dimvalues.SetRange(Dimvalues.Code, "Requisition Header1"."Global Dimension 2 Code");
                if Dimvalues.Find('-') then
                    Department := Dimvalues.Name;
                employee.Reset;
                if employee.Get("Requisition Header1"."Employee Code") then begin
                    Dimvalues.SetRange(Dimvalues."Dimension Code", GenLedSetup."Global Dimension 1 Code");
                    Dimvalues.SetRange(Dimvalues.Code, employee."Global Dimension 1 Code");
                    if Dimvalues.Find('-') then
                        Directorate := Dimvalues.Name;
                end;
                ...
                if ApprovalEntries.Find('-') then begin
                    ...
                    repeat
                        ...
                        if i = 1 then begin
                            ...
                            "3rdapprover" := ApprovalEntries."Sender ID";
                            "3rdapproverdate" := ApprovalEntries."Date-Time Sent for Approval";
    ...
    var
        ...
        REQUESTED_QTYCaptionLbl: label 'REQUESTED QTY';
        DESCRIPTIONCaptionLbl: label 'DESCRIPTION';
        UNITCaptionLbl: label 'UNIT';
        APPROVED_QTYCaptionLbl: label 'APPROVED QTY';
        No_CaptionLbl: label 'No.';
        ToCaptionLbl: label 'To';
        Procurement_ManagerCaptionLbl: label 'Procurement Manager';
        Please_Issue_the_following_items_on_our_behalfCaptionLbl: label 'Please Issue the following items on our behalf';
        Unit_PriceCaptionLbl: label 'Unit Price';
        Total_CostCaptionLbl: label 'Total Cost';
        Date_CaptionLbl: label 'Date:';
        NO_Caption_Control1000000126Lbl: label 'NO.';
        QTY_IN_STORECaptionLbl: label 'QTY IN STORE';
        PREPARED_BYCaptionLbl: label 'PREPARED BY';
        RECEIVED__BY_CaptionLbl: label 'RECEIVED  BY ';
        ...
        DATE__________________________________________________Caption15Lbl: label 'DATE';
        DirectorateCaptionLbl: label 'Directorate';
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511004_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511004;
