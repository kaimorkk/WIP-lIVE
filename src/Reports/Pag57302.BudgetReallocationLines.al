page 57302 "Budget Reallocation Lines"
{
    ...
    SourceTableView = where("ReAllocation Request" = const(false));
                ...
                action("Allocation Lines")
                {
                    ...
                    begin
                        ...
                        if BudgetReAllocHeader.get("Document No") then begin
                            if BudgetReAllocHeader."Approval Status" <> BudgetReAllocHeader."Approval Status"::Open then
                                ReAllocationLines.Editable := false;
                        end;
    ...
    begin
        ...
        Rec."ReAllocation Request" := false;
    end;
