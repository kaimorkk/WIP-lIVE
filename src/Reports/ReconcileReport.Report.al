...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511021_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511021) { }
//type("System.IO.Path"; System_IO_Path51511021) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193459 "Reconcile Report"
{
    RDLCLayout = './Layouts/ReconcileReport.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Bank Acc. Reconciliation Line"; "Bank Acc. Reconciliation Line")
        {
            ...
            column(Bank_Acc__Reconciliation_Line_Description; "Bank Acc. Reconciliation Line".Description)
            {
            }
            // column(Bank_Acc__Reconciliation_Line_Reconciled; Reconciled)
            // {
            // }
            column(Bank_Acc__Reconciliation_Line__Check_No__; "Bank Acc. Reconciliation Line"."Check No.")
            {
            }
            column(Bank_Acc__Reconciliation_Line__Applied_Amount_; "Bank Acc. Reconciliation Line"."Applied Amount")
            {
            }
            column(Bank_Acc__Reconciliation_Line__Statement_Amount_; "Bank Acc. Reconciliation Line"."Statement Amount")
            {
            }
            column(Bank_Acc__Reconciliation_Line_Difference; "Bank Acc. Reconciliation Line".Difference)
            {
            }
            ...
            begin
                if "Bank Acc. Reconciliation Line"."Statement Amount" < 0 then
                    TotalReconciledCredit := TotalReconciledCredit + Abs("Bank Acc. Reconciliation Line"."Statement Amount")
                else
                    TotalReconciledDebit := TotalReconciledDebit + "Bank Acc. Reconciliation Line"."Statement Amount";
            end;

        }
        dataitem("Bank Acc. Reconciliation Line4"; "Bank Acc. Reconciliation Line")
        {
            // DataItemTableView = sorting(Field50000, "Transaction Date") order(descending) where(Field50000 = filter(Yes), "Statement Amount" = filter(< 0));
            PrintOnlyIfDetail = false;
        ...
        {
            // DataItemTableView = sorting(Field50000, "Transaction Date") order(descending) where(Field50000 = filter(No), Difference = filter(<> 0), "Statement Amount" = filter(> 0));
            PrintOnlyIfDetail = false;
        ...
        dataitem("Bank Acc. Reconciliation Line5"; "Bank Acc. Reconciliation Line")
        {
            // DataItemTableView = sorting(Field50000, "Transaction Date") order(descending) where(Field50000 = filter(No), Difference = filter(<> 0), "Statement Amount" = filter(< 0));
        ...
        dataitem("Bank Acc. Reconciliation Line2"; "Bank Acc. Reconciliation Line")
        {
            // DataItemTableView = sorting(Field50000, "Transaction Date") order(descending) where(Field50000 = filter(No), "Applied Amount" = filter(<> 0), "Statement Amount" = filter(> 0));
            PrintOnlyIfDetail = false;
        ...
        dataitem("Bank Acc. Reconciliation Line6"; "Bank Acc. Reconciliation Line")
        {
            // DataItemTableView = sorting(Field50000, "Transaction Date") order(descending) where(Field50000 = filter(No), "Applied Amount" = filter(<> 0), "Statement Amount" = filter(< 0));
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511021_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511021;
