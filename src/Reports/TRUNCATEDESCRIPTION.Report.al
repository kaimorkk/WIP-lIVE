...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511221_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511221) { }
//type("System.IO.Path"; System_IO_Path51511221) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193626 "TRUNCATE DESCRIPTION"
{
    RDLCLayout = './Layouts/TRUNCATEDESCRIPTION.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Gen. Journal Line"; "Gen. Journal Line")
        {
            ...
            column(Gen__Journal_Line__Journal_Template_Name__Control1000000014; "Gen. Journal Line"."Journal Template Name")
            {
            }
            ...
            column(Gen__Journal_Line_Amount_Control1000000029; "Gen. Journal Line".Amount)
            {
            }
            column(TotalFor___FIELDCAPTION__Journal_Template_Name__; TotalFor + FieldCaption("Journal Template Name"))
            {
            }
            column(Gen__Journal_Line_Amount_Control1000000031; "Gen. Journal Line".Amount)
            {
            }
            ...
            column(Gen__Journal_Line__Journal_Template_Name__Control1000000014Caption; FieldCaption("Journal Template Name"))
            {
            }
            ...
            column(Gen__Journal_Line_Line_No_; "Gen. Journal Line"."Line No.")
            {
            }
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511221_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511221;
