...
// {
//   type(ForNav.Report_7_3_0_2559; ForNavReport51511239_v7_3_0_2559) { }
//}
//assembly("mscorlib")
//  {
//    Version = '4.0.0.0';
//    type("System.IO.Stream"; SystemIOStream51511239) { }
//type("System.IO.Path"; System_IO_Path51511239) { }
//   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193643 "Petty Cash Voucher"
{
    ...
    dataset
    {
        dataitem("Request Header1"; "Request Header1")
        {
            ...
            column(PETTY_CASH_VOUCHERCaption; PETTY_CASH_VOUCHERCaptionLbl)
            {
            }
            ...
            column(Request_Header1_No_; "Request Header1"."No.")
            {
            }
            ...
            begin
                PCVNo := '';
                BankLedger.Reset;
                BankLedger.SetRange(BankLedger."External Document No.", "Request Header1"."No.");
                if BankLedger.Find('-') then
                    PCVNo := BankLedger."Document No.";
                Netamt := 0;
                DimValues.Reset;
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511239_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511239;
