...
//{
    ...
    // {
    //   type(ForNav.Report_7_3_0_2559; ForNavReport51511105_v7_3_0_2559) { }
    //}
    //assembly("mscorlib")
    //  {
    //    Version = '4.0.0.0';
    //    type("System.IO.Stream"; SystemIOStream51511105) { }
    //type("System.IO.Path"; System_IO_Path51511105) { }
    //   }
//} // Reports ForNAV Autogenerated code - do not delete or modify -->

Report 52193525 "kcaa update"
{
    RDLCLayout = './Layouts/kcaaupdate.rdlc';
    DefaultLayout = RDLC;
    ...
    dataset
    {
        dataitem("Assignment Matrix-X1"; "Assignment Matrix-X1")
        {
            ...
            column(Assignment_Matrix_X1__Tax_Deductible_; "Assignment Matrix-X1"."Tax Deductible")
            {
            }
            ...
            column(Assignment_Matrix_X1__Tax_Deductible_Caption; FieldCaption("Tax Deductible"))
            {
            }
            ...
            begin
                if "Assignment Matrix-X1"."Employer Amount" = 0 then begin
                    "Assignment Matrix-X1"."Employer Amount" := Abs("Assignment Matrix-X1".Amount * (12.5 / 6.5));
    ...
    var
        //[WithEvents]
        //ReportForNav: DotNet ForNavReport51511105_v7_3_0_2559;
    ...
    var
        ...
        path: DotNet System_IO_Path51511105;
