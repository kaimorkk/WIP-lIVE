Table 52193868 "Employee Leave Plan1"
{
    DrillDownPageID = "Employee Leave Application";
    LookupPageID = "Employee Leave Application";
    ...
    var
        ...
        textholder: Text[30];
        emp: Record Employee;
        leaveapp: Record "Employee Leave Plan1";
