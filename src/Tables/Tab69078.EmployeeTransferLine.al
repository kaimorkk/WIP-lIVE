table 69078 "Employee Transfer Line"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Open,Pending Approval,Released,Rejected,Awaiting HOS,HOS Confirmed,Pending HOD Reccomendation,Pending Mobility Officer,Pending Head of Mobility,Pending HR Approval,Pending Current HOS Release,Submitted';
        ...
        {
            OptionCaption = 'Self initiated, Management initiated,...,Bulk Management initiated';
            OptionMembers = "Self initiated","Management initiated","...","Bulk Management initiated";
            Editable = false;
        }
        ...
        field(70106; "Mobility Release Date"; Date)
        {
            trigger OnValidate()
            begin
                "Reporting Date" := "Release Date" + 30;
            end;
        }
