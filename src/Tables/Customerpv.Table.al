Table 52193584 "Customer pv"
{
    ...
    fields
    {
        ...
        field(12;"CHEQUE NO";Code[10])
        {
            ...
            trigger OnValidate()
            begin
                if "cashier receipt"."Receipt Mode"='CHEQUE' then
        ...
        field(24;"Activity Code";Code[20])
        {
            ...
            trigger OnValidate()
            begin
                ///ValidateShortcutD(1,"Shortcut Dimension 1 Code");
            end;
        }
    }
    ...
    begin
        /*IF No = '' THEN BEGIN
         GenLedgerSetup.GET;
        GenLedgerSetup.TESTFIELD(GenLedgerSetup."Payment Vouchers No");
         NoSeriesMgt.InitSeries(GenLedgerSetup."Payment Vouchers No",xRec."No. Series",0D, No,"No. Series");
        END;*/
        "Payment Date":=Today;
        Cashier:=UserId;
