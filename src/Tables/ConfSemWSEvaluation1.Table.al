Table 52193871 "Conf/Sem/WS Evaluation1"
{
    ...
    fields
    {
            ...
            begin
                ...
                begin
                 ...
                 Designation:=TrainingReq.Designation;
                  Insitution:=TrainingReq.Insitution;
        ...
        field(36;"Issues Discussed 1";Text[150])
        {
        }
        field(37;"Issues Discussed 2";Text[150])
        {
        }
        field(38;"Issues Discussed 3";Text[150])
        {
        }
        field(39;"Issues Discussed 4";Text[150])
        {
        }
        field(40;"Follow Up 1";Text[150])
        {
        }
        field(41;"Follow Up 2";Text[150])
        {
        }
        field(42;"Difficult 1";Text[150])
        {
        }
        field(43;"Difficult 2";Text[150])
        {
        }
        field(44;"Suggestion 1";Text[150])
        {
        }
        field(45;"Suggestion 2";Text[150])
        {
        }
        field(46;"Suggestion 3";Text[150])
        {
        }
        field(47;"Suggestion 4";Text[150])
        {
        }
    }
    ...
    begin
        if "No." = '' then begin
          HumanResSetup.Get;
          HumanResSetup.TestField(HumanResSetup."Conf/Sem Evaluation");
          NoSeriesMgt.InitSeries(HumanResSetup."Conf/Sem Evaluation",xRec."No. Series",0D,"No.","No. Series");
        //"GL Account":=HumanResSetup."Account No (Training)";   HumanResSetup."Training Evaluation Nos"
        end;
    ...
    var
        ...
        TrainingReq: Record "Conf/Sem/WS Evaluation1";
