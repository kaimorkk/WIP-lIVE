   ...
   table 52194034 "Receipts Header1"
{
    ...
    fields
    {
        ...
        field(41; "Employer Code"; Code[40])
        {
            DataClassification = ToBeClassified;
        }
        field(42; Remarks; Text[400])
        {
            DataClassification = ToBeClassified;
        }
                ...
                case
                    ...
                    "Receipt Type"::Deposit:
                        begin
                            ...
                            // DefaultDimens/ionsRec.GetDimensionCodes(DefaultDimensionsRec."Document Type"::"Deposit Receipt", DefaultDimensions);
                        end;
                    "Receipt Type"::Fee:
                        begin
                            CashMgt.Get;
