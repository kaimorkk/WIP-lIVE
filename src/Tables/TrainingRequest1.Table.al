Table 52193860 "Training Request1"
{
    ...
    fields
    {
        ...
        {
            CalcFormula = count("Approval Entry" where ("Table ID"=const(51511185),
        ...
        {
            CalcFormula = sum("Training Participants"."Tuition Fee Distribution" where ("Training Request"=field("Request No.")));
            FieldClass = FlowField;
        ...
        {
            CalcFormula = sum("Training Participants"."Per Diem Distribution" where ("Training Request"=field("Request No.")));
            FieldClass = FlowField;
        ...
        {
            CalcFormula = sum("Training Participants"."Air Ticket Distribution" where ("Training Request"=field("Request No.")));
            FieldClass = FlowField;
        ...
        {
            CalcFormula = sum("Training Participants"."Imprest Distribution" where ("Training Request"=field("Request No.")));
            FieldClass = FlowField;
        ...
        {
            CalcFormula = sum("Training Participants"."Travel Docs Fees Dstrbtn" where ("Training Request"=field("Request No.")));
            FieldClass = FlowField;
