Table 52194024 "Employee Appraisals-Probation"
{
    ...
    fields
    {
        ...
        field(30;"Date of First Appointment";Date)
        {
        }
        field(31;"Post on First Appointment";Code[20])
        {
            TableRelation = "Company Jobs1";
        }
        field(32;"Present Substantive Post";Code[20])
        {
            TableRelation = "Company Jobs1";
        }
        field(33;"Date of Promotion";Date)
        {
        }
        field(34;"Main Resposibilities/Functions";Text[250])
        {
        }
        field(35;"Acting Appointment(If any)";Text[100])
        {
        }
        field(36;"Start of Acting";Date)
        {
        }
        field(37;"End of Acting";Date)
        {
        }
        field(38;"Overall Grading";Decimal)
        {
        }
        field(39;"Overall Score(%)";Decimal)
        {
        }
        field(40;"Total Score(Self Eval)";Decimal)
        {
            CalcFormula = sum("Appraisal Lines-Probation"."Performance Ratings(%)" where ("Appraisal Heading Type"=const("Perfomance Evaluation(Self)")));
        ...
        field(41;"Total Score(Appraiser Eval)";Decimal)
        {
            CalcFormula = sum("Appraisal Lines-Probation"."Performance Ratings(%)" where ("Appraisal Heading Type"=const("Perfomance Evaluation(Appraiser)")));
            FieldClass = FlowField;
        ...
        field(42;"Self Eval Total Score (%)";Decimal)
        {
        }
        field(43;"Appraiser Eval Total Score (%)";Decimal)
        {
        }
        field(44;"Appraisal End Date";Date)
        {
        }
        field(45;"Appraisal Start Date";Date)
        {
        }
        field(46;"Department Name";Text[50])
        {
        }
        field(47;"Directorate Code";Code[20])
        {
        }
        field(48;"Directorate Name";Text[50])
        {
        }
    }
    ...
    begin
        if "Appraisal No" = '' then begin
          ...
          NoSeriesMgt.InitSeries(HumanResSetup."Training Needs Request Nos",xRec."No. series",0D,"Appraisal No","No. series");
        end;
        ...
        // ApraisalPeriods.SETRANGE(ApraisalPeriods."End Date",0D,);
         ...
         repeat
             if (ApraisalYears."Start Date"<=Date) and (ApraisalYears."End Date">=Date)then
               "Acting Appointment(If any)":=ApraisalYears.Period;
    ...
    var
        ...
        AppraisalLines: Record "Appraisal Lines-Probation";
        AppraisalFormat: Record "Appraisal Formats-Probation";
        ...
        EmpAppraisal: Record "Employee Appraisals-Probation";
