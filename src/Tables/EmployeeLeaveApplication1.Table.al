        ...
        field(3;"Leave Code";Code[20])
        {
            ...
            begin
                ...
                begin
                 ...
                 if LeaveTypes."Annual Leave"=false then
                 begin
                 ...
                 end else if LeaveTypes."Annual Leave"=true then
                 begin
                  ...
                  if ("Date of Joining Company"<>0D) and ("Date of Joining Company">"Fiscal Start Date") then begin
                    ...
                    */
                    ...
                    begin
                     ...
                     end else if LeaveTypes."Eligible Staff"=LeaveTypes."eligible staff"::"Temporary" then
                     begin
