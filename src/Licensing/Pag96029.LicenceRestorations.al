page 96029 "Licence Restorations"
{
    ApplicationArea = All;
    Caption = 'Licence Restorations';
    PageType = List;
    ...
    DeleteAllowed = false;
    ModifyAllowed = false;
    SourceTableView = where("Application Type" = filter(Restoration), Status = filter(Open|"Pending Approval"), Closed = filter(false));
