page 96017 "Licence Renewals"
{
    ApplicationArea = All;
    Caption = 'Licence Renewals';
    PageType = List;
    ...
    DeleteAllowed = false;
    ModifyAllowed = false;
    SourceTableView = where("Application Type" = filter(Renewal), Status = filter(Open|"Pending Approval"), Closed = filter(false));
