TableExtension 52193768 tableextension52193768 extends "Analysis Column" 
{
    fields
    {

        //Unsupported feature: Code Modification on ""Comparison Period Formula"(Field 13).OnValidate".
    ...
    //Unsupported feature: Deletion (VariableCollection) on "ParsePeriodFormula(PROCEDURE 26).OldLanguageID(Variable 1005)".


    //Unsupported feature: Deletion (VariableCollection) on "ParsePeriodFormula(PROCEDURE 26).FormulaParseErrorText(Variable 1004)".
