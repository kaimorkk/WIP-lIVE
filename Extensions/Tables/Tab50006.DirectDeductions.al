table 50006 "Director Deductions"
{
    ...
    fields
    {
        ...
        {
            OptionCaption = 'Flat Amount,% of Basic Pay,Based on Table,Based on Hourly Rate,Based on Daily Rate ,% of Gross Pay,% of Basic Pay+Hse Allowance';
